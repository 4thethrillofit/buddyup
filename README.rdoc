...
The pairing is not 100% guaranteed to be unique since orphan members can appear through certain combination of pairing permutations when there many pairs. When this happened, the orphan members are randomly shuffled and paired together.
